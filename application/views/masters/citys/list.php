                    ...
                    <div class="card-head">
                        <div class="row" style="padding:20px;">
                            ...
                            <div class="col-lg-2 text-right">
                                <button class="btn btn-primary mb-sm-0 mb-3 print-invoice" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target=".bd-example-modal-lg" onclick="add(0)"> Add City</button>
                            </div>                        
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    function add(id){
        $.ajax({
            url : "<?php echo base_url('city/add'); ?>",
            data : {id:id},
            type: "GET",
            dataType: "html",
            success: function(data)
            {
                ...
                $('.myselect').select2({dropdownParent: $("#model-data")}); 
                $('.myselect').select2({minimumResultsForSearch: 5});
            },
