                            ...
                            <table  class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Team(5%) Leadership(5%) Bonus = (10%)th>
                                        <th>Education(5%) Safety(5%) Bonus = (10%)</th>
                                        <th>Lifestyle(5%) Travel Fund(5%) Bonus = (10%)	</th>
                                        <th>Car Fund(5%) House Fund(5%) Bonus = (10%)</th>
                                        <th style="width:100px;">Royality Income(10%) Bonus = (10%)</th>
...
$(document).ready(function() {
	...
	table = $('#zero_configuration_table').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('lifetime/ajax_list') ?>",
            "type": "POST",
            "data": function ( data ) {
    ...
    function add(id){
        $.ajax({
            url : "<?php echo base_url('lifetime/add'); ?>",
            data : {id:id},
            type: "GET",
            dataType: "html",
    ...
    function deleter(id){
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                    url : "<?php echo base_url('lifetime/delete/'); ?>",
                    data : {id: id},
                    type: "POST",
                    dataType: "html",
                    success: function(data)
