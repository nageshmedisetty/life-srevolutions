<div class="modal-dialog modal-lg" id="example-modal-lg">
    ...
    <?php
        ...
        echo form_open_multipart("subcategory/update", $attrib)
    ?>   
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <?php	
                                ...
                                echo form_dropdown('category', $gs, ($row ? $row->category : ""), 'class="form-control myselect" id="category" data-placeholder="Select Category" required="required" style="width:100%"')
                            ?>													
                        </div>
                    </div>	
                    <div class="col-sm-6">
