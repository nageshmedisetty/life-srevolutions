                        ...
                        <div class="col-xl-12 col-md-6 col-12">
                            <div class="card card-statistics">
                                <div class="card-header">
                                    <h4 class="card-title">Referal Tree</h4>
                                    <div class="d-flex align-items-center">
                                        <p class="card-text font-small-2 mr-25 mb-0">Referal Three Members Wise</p>
                                    </div>
                                </div>
                                <div class="card-body statistics-body">
                                    <div class="row">
                                        <div class="body genealogy-body genealogy-scroll"  style="width: 100%;height: 700px;">
                    ...
                    <div class="row match-height">
                        ...
                        <div class="card card-statistics">
                                <div class="card-header">
                                    <h4 class="card-title">Referal Tree</h4>
                                    <div class="d-flex align-items-center">
                                        <p class="card-text font-small-2 mr-25 mb-0">Referal Two Members Wise</p>
                                    </div>
                                </div>
                                <div class="card-body statistics-body">
                                    <div class="row">
